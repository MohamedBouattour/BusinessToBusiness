...
import cas.config.audit.AuditEventConverter;
import cas.domain.PersistentAuditEvent;
...
import static cas.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
