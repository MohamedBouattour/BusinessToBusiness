...
import { IAppointment, Appointment, EtatAppointment } from 'app/shared/model/appointment.model';
...
describe('Service Tests', () => {
  describe('Appointment Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Appointment(0, currentDate, 'AAAAAAA', 'AAAAAAA', 0, EtatAppointment.Active, 0, 0);
    });
