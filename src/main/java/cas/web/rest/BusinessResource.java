...
/**
 * REST controller for managing {@link cas.domain.Business}.
 */
@RestController
@RequestMapping("/api")
public class BusinessResource {
    ...
    @GetMapping("/businesses/getbysector/{id}")
    public List<Business> getBusinessBySector(@PathVariable Long id) {
        log.debug("REST request to get Business : {}", id);
        List<Business> business = businessRepository.findBySubsector_Sector_id(id);
        return business;
    }
}
